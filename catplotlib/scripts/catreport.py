...
def copy_and_configure(template, output_path, results_dbs, bounding_box=None):
    ...
    write_provider_strings(output_path, results_dbs, bounding_box)

def write_provider_strings(template_path, results_dbs, bounding_box=None):
    provider_paths = "{"
...
def cli():
    ...
    copy_and_configure(args.template, args.report_path, results_dbs, args.bounding_box)
